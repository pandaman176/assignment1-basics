...
def run_linear(
    ...
    """
    linear = MyModules.Linear(d_in, d_out)
...
def run_embedding(
    ...
    """
    embedding = MyModules.Embedding(vocab_size, d_model)
...
def run_swiglu(
    ...
    swiglu = MyModules.SwiGLU(d_model, d_ff)
...
def run_scaled_dot_product_attention(
    ...
    """
    return MyModules.scaled_dot_product_attention(Q, K, V, mask)
    raise NotImplementedError
...
def run_rope(
    ...
    """
    rope = MyModules.RoPE(theta, d_k, max_seq_len)
...
def run_rmsnorm(
    ...
    """
    rms_norm = MyModules.RMSNorm(d_model, eps)
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    return MyModules.silu(in_features)
    raise NotImplementedError
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return MyModules.softmax(in_features, dim)
    raise NotImplementedError
...
def run_cross_entropy(
    ...
    """
    return MyModules.cross_entropy_loss(inputs, targets)
    raise NotImplementedError
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return MyModules.clip_grad_norm_(parameters, max_l2_norm)
    raise NotImplementedError
...
def run_get_lr_cosine_schedule(
    ...
    """
    return MyModules.cosine_decay_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
    raise NotImplementedError
